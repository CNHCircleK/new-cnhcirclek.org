...
function sunnyCNH_register_scripts() {
    ...
    wp_enqueue_script('sunnyCNH-popper', 'https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js', array(), '1.16.0', true);
    wp_enqueue_script('sunnyCNH-bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootst', array(), '4.4.1', true);
